...
import com.example.androidmultichoicequiz.Adapter.ResultGridAdapter;
...
public class ResultActivity extends AppCompatActivity {
    ...
    ResultGridAdapter adapter,filterdAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        btn_filter_no_answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                filterdAdapter=new ResultGridAdapter(ResultActivity.this,Common.answerSheetListFiltered);
                recycler_result.setAdapter(filterdAdapter);
            }
